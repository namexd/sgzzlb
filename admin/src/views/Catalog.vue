    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-card>
          ...
          <el-table :data="filteredGenerals" style="width: 100%" max-height="600" v-loading="loading">
      ...
      <el-col :span="12">
        <el-card>
          ...
          <el-table :data="filteredTactics" style="width: 100%" max-height="600" v-loading="loading">
...
import { getGenerals, getTactics } from "../api";
...
onMounted(async () => {
  loading.value = true;
  try {
    const [genRes, tacRes] = await Promise.all([
