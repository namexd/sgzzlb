...
scp "$LOCAL_DIR/server/catalogDiff.js" "$SERVER:$REMOTE_DIR/backend/"
scp "$LOCAL_DIR/server/catalogVersionStore.js" "$SERVER:$REMOTE_DIR/backend/"
scp "$LOCAL_DIR/server/officialCatalogFetcher.js" "$SERVER:$REMOTE_DIR/backend/"
